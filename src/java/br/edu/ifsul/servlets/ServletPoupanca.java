    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(acao==null){
            ...
            tela = "listar.jsp";
                ...
                dao.getObjetoSelecionado().setAgencia(new AgenciaDAO().localizar(Integer.parseInt(request.getParameter("agencia"))));
                dao.getObjetoSelecionado().setAtiva(Boolean.parseBoolean(request.getParameter("ativa")));
                dao.getObjetoSelecionado().setCliente(new ClienteDAO().localizar(Integer.parseInt(request.getParameter("cliente")))); 
                ...
                dao.getObjetoSelecionado().setTaxa_atualizacao(Double.parseDouble(request.getParameter("taxa")));
